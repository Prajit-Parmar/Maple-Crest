...
export default function Footer() {
  return (
    <footer className="bg-dark-2 border-t border-primary/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              {[
                ...
                <Link key={link.href} href={link.href} className="text-gray-400 hover:text-primary transition-colors text-sm">
                  {link.label}
                </Link>
              ))}
            </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="tel:+14165558900" className="text-gray-400 hover:text-primary transition-colors text-sm">(416) 555-8900</a>
              </div>
              <div className="flex items-center gap-3">
                <HiEnvelope className="text-primary shrink-0" size={16} />
                <a href="mailto:info@maplecrestdevelopments.ca" className="text-gray-400 hover:text-primary transition-colors text-sm">info@maplecrestdevelopments.ca</a>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex">
              <input type="email" placeholder="Your email" className="flex-1 bg-dark border border-primary/20 rounded-l px-4 py-2 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-primary" />
              <button className="bg-primary text-white font-semibold px-4 py-2 rounded-r text-sm hover:bg-primary-dark transition-colors">Subscribe</button>
            </div>
          </div>
        </div>
      </div>
