      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <div className="flex">
              <input type="email" placeholder="Your email" className="flex-1 bg-dark-2 border border-primary/30 rounded-l px-4 py-2 text-sm text-white placeholder-gray-400 focus:outline-none focus:border-primary" />
